...
function Logo() {
  return <a className="brand" href="#home" aria-label="InstaGrow Solutions home"><span className="brand-mark"><Image src="/instagrow-logo.png" alt="" width={540} height={540} priority /></span><span className="brand-name">Insta<span>Grow</span><sup className="brand-tm" aria-label="Trademark">TM</sup><small>Solutions</small></span></a>;
}
